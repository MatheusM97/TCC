...
public class RelatorioRepresentanteUniversidade extends CustomActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.relatorio_representante_universidade);
    ...
    private void imprimirCabecalho(PdfDocument.PageInfo pageInfo) {
        ...
        canvas.drawText("Relatório de Representante da Universidade", pageInfo.getPageWidth()/2,50, paint);

        String universidade = "Todas";
        ...
        canvas.drawText("Universidade: " + universidade , pageInfo.getPageWidth()/2,68, paint);
    ...
    private void imprimirRodape(PdfDocument.PageInfo pageInfo) {
        ...
        int alunos = 0;
        int professores = 0;
        int representanteUniversidade = 0;
        int atendimentos = 0;
        ...
        paint.setTextAlign(Paint.Align.LEFT);
        paint.setTextSize(15.0f);
        canvas.drawText("Representantes da Universidade: " + representanteUniversidade, 4,hIndex, paint);
    ...
    public void gerar(){
        ...
        paint.setTextAlign(Paint.Align.LEFT);
        paint.setTextSize(13.0f);
        canvas.drawText(String.format("%03d", 1), (indexLoop * 15) + 5, hIndex, paint); //universidade index
        canvas.drawText(ajustarNome(universidadeNome, 45), (indexLoop * 15) + 35, hIndex, paint); //universidade nome

        int qtdParticipantes = 0;
        if (relatorio.getDetalhe() != null) {
            qtdParticipantes = relatorio.getDetalhe().size();
        }
        ...
        Intent intent = new Intent(RelatorioRepresentanteUniversidade.this, PdfVisualizador.class);
    ...
    private void vincularComponentes() {
        ...
        this.spinnerUniversidade = findViewById(R.id.sp_universidade);
        this.universidadeLista = Persistencia.getInstance().getUniversidades();

        this.universidadeAdapter = new ArrayAdapter<Universidade>(this, android.R.layout.simple_spinner_dropdown_item, this.universidadeLista);
        this.universidadeAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        this.spinnerUniversidade.setAdapter(universidadeAdapter);
        ...
        this.tvDataInicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        RelatorioRepresentanteUniversidade.this,
    ...
    private void consultarAtendimentos(){
        ...
        try {
            ...
            if(universidade.getId() != null){
                universidadeId = universidade.getId();
                universidadeNome = universidade.getNome();
            }

            Persistencia.getInstance().instanciarEstatisticas();
            Persistencia.getInstance().estatisticaUniversidade(universidadeId, dataInicial, dataFinal);
