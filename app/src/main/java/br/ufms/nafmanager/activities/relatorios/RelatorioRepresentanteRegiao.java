...
public class RelatorioRepresentanteRegiao extends CustomActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.relatorio_representante_regiao);
    ...
    private void imprimirCabecalho(PdfDocument.PageInfo pageInfo) {
        ...
        canvas.drawText("Relatório de Representante da Região Fiscal", pageInfo.getPageWidth()/2,50, paint);
    ...
    private void imprimirRodape(PdfDocument.PageInfo pageInfo) {
        ...
        for(RelatorioObjeto unidade: relatorio.getDetalhe()){
            unidades++;
            representanteUnidade+= unidade.getDetalhe2().size();
    ...
    public void gerar(){
        ...
        for(RelatorioObjeto unidade: relatorio.getDetalhe()) {//regioes
            ...
            for(RelatorioObjeto representanteUnidade: unidade.getDetalhe2()){
                canvas.drawText("Representante: "+ representanteUnidade.getNome(), (indexLoop * 15) + 5 , hIndex, paint); //representante da unidade
                verificarQuebra();
            }
            ...
            for (RelatorioObjeto universidade : unidade.getDetalhe()) {//unidades
                ...
                if (universidade.getDetalhe() != null) {
                    qtdParticipantes = unidade.getDetalhe().size();
                }
        ...
        Intent intent = new Intent(RelatorioRepresentanteRegiao.this, PdfVisualizador.class);
        ...
        this.tvDataInicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        RelatorioRepresentanteRegiao.this,
    ...
    public void capturarUsuarios(){
        if(Persistencia.getInstance().estatisticasUsuarioComAcesso() && Persistencia.getInstance().representantesTraduzidos()){
            Persistencia.getInstance().ajustarDadosRegiao();
            hideDialog();
            gerar();
        }
        else{
    ...
    private void consultarAtendimentos(){
        ...
        try {
            ...
            Persistencia.getInstance().estatisticaRegiao(regiaoId, dataInicial, dataFinal);
